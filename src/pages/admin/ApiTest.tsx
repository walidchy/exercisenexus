            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t">
                <p className="text-sm text-muted-foreground">
                  <strong>To connect to your backend:</strong> Update the <code className="bg-muted px-1 rounded">USE_MOCK_DATA</code> value in <code className="bg-muted px-1 rounded">src/config/api.ts</code> to <code className="bg-muted px-1 rounded">false</code> and ensure your API is properly configured.
                </p>
              </div>
            </div>
          </CardContent>
